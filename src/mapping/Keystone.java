...
public class Keystone {
	...
	public void nextSurface() {
		selectedIndex = (selectedIndex + 1) % surfaces.size();
	}
	...
	public void draw() {
		if (calibrate) {
			surfaces.get(selectedIndex).renderControlPoints(parent.getGraphics());
		}
	}
	...
	public void mouseEvent(MouseEvent e) {
		...
		case MouseEvent.PRESS:
			CornerPinSurface surface = surfaces.get(selectedIndex);
			dragged = surface.select(x, y);
			break;
